 ...
 /* Layout da mensagem  */
 $corpo_mensagem = " 
 <br>Formulário - trabalhe conosco - Yvy Reciclagem
 <br>--------------------------------------------<br>
...
';
 ...
 if(file_exists($arquivo["tmp_name"]) and !empty($arquivo)){
  ...
  fclose($fp); // Fecha o arquivo aberto anteriormente
     ...
     $mensagem2.= "$corpo_mensagem_confirma\n";
 }
 ...
 if(mail($to, $assunto, $mensagem, $headers) and mail($confirma, 'Recebemos seu formulário - Yvy Reciclagem', $mensagem2, $headers))
 {
    echo '<!DOCTYPE html>
    <html lang="pt-BR">
    <head>
