...
<link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap.min.css">
 ...
 $to = $replyto;
 $to2 = "ouvidoria@yvyreciclagem.com.br";
 $remetente = "ouvidoria@yvyreciclagem.com.br"; // Deve ser um email válido do domínio
 ...
 /* Layout da mensagem  */
 $corpo_mensagem = " 
 <br>Formulário - ouvidoria - site Yvy Reciclagem
 <br>--------------------------------------------<br>
...
';
 ...
 if(mail($to2, $assunto, $mensagem, $headers))
 {
    echo '<!DOCTYPE html>
    <html lang="pt-BR">
    <head>
